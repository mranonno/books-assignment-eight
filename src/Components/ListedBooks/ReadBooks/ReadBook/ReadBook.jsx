...
const ReadBook = ({ readBook }) => {
  ...
  return (
    <div className="flex flex-col lg:flex-row lg:items-center lg:gap-6 gap-4 text-start font-sans border rounded-2xl lg:p-6 p-4 mt-4 lg:mt-8">
      ...
      <div className="lg:flex-grow text-start">
        ...
        <div className="flex flex-col lg:flex-row lg:items-center lg:gap-3 mt-4">
